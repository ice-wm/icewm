...
XFV(const char *, titleFontName,                FONT(12,120), FSANS)
XFV(const char *, menuFontName,                 BOLDFONT(10,100), FSMAL)
XFV(const char *, statusFontName,               BOLDTTFONT(12,120), FMONB)
XFV(const char *, switchFontName,               BOLDTTFONT(12,120), FMONB)
XFV(const char *, normalButtonFontName,         FONT(12,120), FSANS)
XFV(const char *, activeButtonFontName,         BOLDFONT(12,120), FBOLD)
XFV(const char *, normalTaskBarFontName,        FONT(12,120), FSANS)
XFV(const char *, activeTaskBarFontName,        BOLDFONT(12,120), FBOLD)
XFV(const char *, toolButtonFontName,           FONT(12,120), FSANS)
XFV(const char *, normalWorkspaceFontName,      FONT(12,120), FSANS)
XFV(const char *, activeWorkspaceFontName,      FONT(12,120), FSANS)
XFV(const char *, listBoxFontName,              FONT(12,120), FSANS)
XFV(const char *, labelFontName,                FONT(14,140), FSANS)
